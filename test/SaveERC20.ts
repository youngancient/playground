import {
  ...
  describe("SaveERC20", function () {
    ...
    async function deployToken() {
      ...
      const erc20Token = await hre.ethers.getContractFactory("CampaignToken");
    ...
    describe("Deposit", function () {
      it("Should deposit successfully", async function () {
        ...
        expect(await saveErc20.connect(otherAccount).getMyBalance()).to.equal(depositAmount);
    ...
    describe("Withdraw", function () {
      it("Should deposit successfully", async function () {
        ...
        expect(await saveErc20.connect(otherAccount).getMyBalance()).to.equal(depositAmount - withdrawAmount);
